...
<head>
  ...
  <body>
<div class="flex min-h-screen md:flex-row-reverse flex-wrap">
  <div class="w-full md:w-10/12 bg-gray-200 flex justify-center p-4 items-center">
  
  <form action="buy2.php" class="w-full max-w-sm items-center" method="post">
    ...
    <div class="md:w-2/3">
      <input class="bg-gray-50 appearance-none border-2 border-gray-400 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="inline-full-name" type="text" name="symbol" placeholder="AAPL">
    </div>
  </div>
  <div class="md:flex md:items-center mb-6">
    <div class="md:w-1/3">
    ...
    <div class="md:w-2/3">
      <input class="bg-gray-50 appearance-none border-2 border-gray-400 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="inline-password" type="text" name="shares" placeholder="100">
    </div>
  </div>
  <div class="md:flex md:items-center">
    <div class="md:w-1/3"></div>
    <div class="md:w-2/3">
      <button class="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold" type="submit">
        BUY
      </button>
    </div>
  </div>
  ...
  <div class="w-full md:w-1/6 h-full min-h-screen shadow-lg bg-gray-900 p-4 text-center text-gray-800">
