...
<head>
    ...
    <title>CC50 Finanças: Deposit</title>
  </head>
...
<div class="flex min-h-screen md:flex-row-reverse flex-wrap">
  ...
  <form action="deposit2.php" class="w-full max-w-sm items-center" method="post">
    ...
    <div class="md:w-2/3">
      <input class="bg-gray-50 appearance-none border-2 border-gray-400 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="inline-full-name" type="text" name="amount" placeholder="1305.45">
    </div>
  </div>
